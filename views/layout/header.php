...
<head>
    ...
    <title><?= $pageTitle ?? 'Conselhos Esotéricos - Portal de Consultas Místicas' ?></title>
    ...
    <nav class="bg-white shadow-sm py-4">
        <div class="max-w-6xl mx-auto px-4 flex justify-between items-center">
            <div class="flex items-center">
                <a href="/">
                    <img src="/logo.png" alt="Conselhos Esotéricos Logo" class="h-16 w-auto">
                </a>
            </div>
            <div class="flex items-center space-x-8">
                <a href="/" class="text-gray-700 hover:text-blue-600 font-medium">HOME</a>
                <a href="/blog" class="text-gray-700 hover:text-blue-600 font-medium">BLOG</a>
                <a href="/consultores" class="text-gray-700 hover:text-blue-600 font-medium">CONSULTORES</a>
                <a href="/creditos" class="text-gray-700 hover:text-blue-600 font-medium">CRÉDITOS</a>
                <a href="/registro" class="text-gray-700 hover:text-blue-600 font-medium">CRIAR CONTA</a>
                <a href="/login" class="text-gray-700 hover:text-blue-600 font-medium">ENTRAR</a>
            </div>
        </div>
    </nav>
