      ...
      <nav className="bg-white shadow-sm py-4">
        <div className="max-w-6xl mx-auto px-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-8">
            ...
            <a href="/consultores" className="text-gray-700 hover:text-blue-600 font-medium">CONSULTORES</a>
            <a href="/creditos" className="text-gray-700 hover:text-blue-600 font-medium">CRÉDITOS</a>
            <a href="/registro" className="text-gray-700 hover:text-blue-600 font-medium">CRIAR CONTA</a>
            <a href="/login" className="text-gray-700 hover:text-blue-600 font-medium">ENTRAR</a>
          </div>
        </div>
      </nav>
